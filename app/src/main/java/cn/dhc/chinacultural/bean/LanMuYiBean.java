...
public class LanMuYiBean {
     ...
     * records : []
     * sqlinfo : {"sql":" SELECT A.TITLE_,'' ARTICLEFROM_,TO_CHAR(BaseFragment.PUBLISH_TIME_,'YYYY-MM-DD HH24:MI:SS') PUBLISH_TIME_,'' PIC,C.TEMPLATE_ID_,A.ID_,D.ID_ CATEGORY_ID_,D.NAME_,A.SOURCE_,BaseFragment.ARTICLE_URL_,BaseFragment.POST_NUM_,A.ALLOWCOMMENTS_ FROM PRODUCT_ARTICLE A,PRODUCT_CATEGORY BaseFragment,PRODUCT_TEMPLATE C,APP_CATEGORY D WHERE A.ID_ = BaseFragment.ARTICLE_ID_ AND BaseFragment.ID_ = C.ARTICLE_CATEGORY_ID_ AND BaseFragment.CATEGORY_ID_ = D.ID_ AND D.ID_ = ? AND BaseFragment.PUBLISH_TIME_ <= TO_DATE(?,'YYYY-MM-DD HH24:MI:SS') ","sqlPaged":"SELECT * FROM( SELECT ROWNUM ROWNUM_, A.* FROM ( SELECT A.TITLE_,'' ARTICLEFROM_,TO_CHAR(BaseFragment.PUBLISH_TIME_,'YYYY-MM-DD HH24:MI:SS') PUBLISH_TIME_,'' PIC,C.TEMPLATE_ID_,A.ID_,D.ID_ CATEGORY_ID_,D.NAME_,A.SOURCE_,BaseFragment.ARTICLE_URL_,BaseFragment.POST_NUM_,A.ALLOWCOMMENTS_ FROM PRODUCT_ARTICLE A,PRODUCT_CATEGORY BaseFragment,PRODUCT_TEMPLATE C,APP_CATEGORY D WHERE A.ID_ = BaseFragment.ARTICLE_ID_ AND BaseFragment.ID_ = C.ARTICLE_CATEGORY_ID_ AND BaseFragment.CATEGORY_ID_ = D.ID_ AND D.ID_ = ? AND BaseFragment.PUBLISH_TIME_ <= TO_DATE(?,'YYYY-MM-DD HH24:MI:SS') ) A WHERE ROWNUM <= 10 ) WHERE ROWNUM_ >= 1 ","args":["1","2018-04-25 19:17:34"],"page":1,"pageRows":10,"totalPage":1,"begin":1,"end":10}
     */
    ...
    public static class SqlinfoBean {
        /**
         * sql :  SELECT A.TITLE_,'' ARTICLEFROM_,TO_CHAR(BaseFragment.PUBLISH_TIME_,'YYYY-MM-DD HH24:MI:SS') PUBLISH_TIME_,'' PIC,C.TEMPLATE_ID_,A.ID_,D.ID_ CATEGORY_ID_,D.NAME_,A.SOURCE_,BaseFragment.ARTICLE_URL_,BaseFragment.POST_NUM_,A.ALLOWCOMMENTS_ FROM PRODUCT_ARTICLE A,PRODUCT_CATEGORY BaseFragment,PRODUCT_TEMPLATE C,APP_CATEGORY D WHERE A.ID_ = BaseFragment.ARTICLE_ID_ AND BaseFragment.ID_ = C.ARTICLE_CATEGORY_ID_ AND BaseFragment.CATEGORY_ID_ = D.ID_ AND D.ID_ = ? AND BaseFragment.PUBLISH_TIME_ <= TO_DATE(?,'YYYY-MM-DD HH24:MI:SS')
         * sqlPaged : SELECT * FROM( SELECT ROWNUM ROWNUM_, A.* FROM ( SELECT A.TITLE_,'' ARTICLEFROM_,TO_CHAR(BaseFragment.PUBLISH_TIME_,'YYYY-MM-DD HH24:MI:SS') PUBLISH_TIME_,'' PIC,C.TEMPLATE_ID_,A.ID_,D.ID_ CATEGORY_ID_,D.NAME_,A.SOURCE_,BaseFragment.ARTICLE_URL_,BaseFragment.POST_NUM_,A.ALLOWCOMMENTS_ FROM PRODUCT_ARTICLE A,PRODUCT_CATEGORY BaseFragment,PRODUCT_TEMPLATE C,APP_CATEGORY D WHERE A.ID_ = BaseFragment.ARTICLE_ID_ AND BaseFragment.ID_ = C.ARTICLE_CATEGORY_ID_ AND BaseFragment.CATEGORY_ID_ = D.ID_ AND D.ID_ = ? AND BaseFragment.PUBLISH_TIME_ <= TO_DATE(?,'YYYY-MM-DD HH24:MI:SS') ) A WHERE ROWNUM <= 10 ) WHERE ROWNUM_ >= 1
